...
public class Game {
  ...
  if(!winnerMessage.equals("None")) {
    ...
    public String checkGameWinner(char [][]grid) {
        String result = "None";
        //Checking code for diagonal of grid [i][j]

        if ((grid[0][0] == grid[1][1] && grid[1][1] == 'x' && grid[2][2] == grid[1][1]) || (grid[0][0] == grid[1][1] && grid[1][1] == 'o' && grid[2][2] == grid[1][1])) {
            if (grid[1][1] == 'x') {
                return "X wins";
            }
            if (grid[1][1] == 'o') {
        ...
        if ((grid[0][2] == grid[1][1] && grid[1][1] == 'x' && grid[2][0] == grid[1][1]) || (grid[0][2] == grid[1][1] && grid[1][1] == 'o' && grid[2][0] == grid[1][1])) {
            if (grid[1][1] == 'x') {
                return "X wins";
            }
            if (grid[1][1] == 'o') {
         ...
         //Checking code for the row of grid


        if ((grid[0][0] == grid[1][0] && grid[1][0] == 'x' && grid[2][0] == grid[1][0]) || (grid[0][0] == grid[1][0] && grid[1][0] == 'o' && grid[2][0] == grid[1][0])) {
            if (grid[1][0] == 'x') {
                return "X wins";
            }
            if (grid[1][0] == 'o') {
        ...
        if ((grid[0][1] == grid[1][1] && grid[1][1] == 'x' && grid[2][1] == grid[1][1]) || (grid[0][1] == grid[1][1] && grid[1][1] == 'o' && grid[2][1] == grid[1][1])) {
            if (grid[1][1] == 'x') {
                return "X wins";
            }
            if (grid[1][1] == 'o') {
        ...
        if ((grid[0][2] == grid[1][2] && grid[1][2] == 'x' && grid[2][2] == grid[1][2]) || (grid[0][2] == grid[1][2] && grid[1][2] == 'o' && grid[2][2] == grid[1][2])) {
            if (grid[1][2] == 'x') {
                return "X wins";
            }
            if (grid[1][2] == 'o') {
        ...
        if ((grid[0][0] == grid[0][1] && grid[0][1] == 'x' && grid[0][2] == grid[0][1]) || (grid[0][0] == grid[0][1] && grid[0][1] == 'o' && grid[0][2] == grid[0][1])) {
           if(grid[0][1]=='x'){
               return "X wins";
           }
           if(grid[0][1]=='o'){
         ...
         //Checking code for the column of grid [i][j]
        ...
        if ((grid[1][0] == grid[1][1] && grid[1][1] == 'x' && grid[1][2] == grid[1][1]) || (grid[1][0] == grid[1][1] && grid[1][1] == 'o' && grid[1][2] == grid[1][1])) {
            if (grid[1][1] == 'x') {
                return "X wins";
            }
            if (grid[1][1] == 'o') {
        ...
        if ((grid[2][0] == grid[2][1] && grid[2][1] == 'x' && grid[2][2] == grid[2][1]) || (grid[2][0] == grid[2][1] && grid[2][1] == 'o' && grid[2][2] == grid[2][1])) {
            if (grid[2][1] == 'x') {
                return "X wins";
            }
            if (grid[2][1] == 'o') {
       ...
       // checking for tie in the grid [i][j]
       int filledSpots=0; int i=0;
        while(i<3) {
            for(int j=0;j<3;j++) {
                //if the value in grid is  not  equals to "-" then we increment the filledSpots by 1
                if(grid[i][j]!='-')
                //update the value of filledSpots
                { filledSpots += 1;
                }            }
            i++;
        }
        //if the value of filledSpots is equals to the value of multiplication of rows and columns then it is a tie
        if(filledSpots== 3 * 3)
        { return "Tie";
        }
